...
public class TestHelloAndLotto {
	public static void main(String[] args) {
		...
		//ApplicationContext ctx = new AnnotationConfigApplicationContext(SpringJavaConfig.class); //Java 配置
		//ApplicationContext ctx = new AnnotationConfigApplicationContext(SpringJavaConfig2.class); //Java 配置
